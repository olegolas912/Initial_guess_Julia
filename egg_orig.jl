...
day = si_unit(:day)
case = setup_case_from_data_file(joinpath("D:\\convergance_tests\\inj_check_one_year", "Egg_Model_ECL.DATA"))
...
function simulation(data_file;
                    ...
                    max_timestep             = 315_360_000_000_000,
                    min_timestep             = 1.0e-6,
...
simulation(raw"D:\\convergance_tests\\inj_check_one_year\\QINJ_120\\Egg_Model_ECL.DATA")